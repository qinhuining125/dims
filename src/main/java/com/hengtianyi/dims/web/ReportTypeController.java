 ...
 */
@Controller
@RequestMapping(value = ReportTypeController.MAPPING)
public class ReportTypeController extends AbstractBaseController<ReportTypeEntity, String> {

  private static final Logger LOGGER = LoggerFactory.getLogger(ReportTypeController.class);
  public static final String MAPPING = "a/reportType";

  @Resource
  private ReportTypeService reportTypeService;

  @Override
  public ReportTypeService getService() {
  ...
  public String index(Model model) {
    ...
    return "web/reportType/reportType_index";
  }
  ...
  public String edit(Model model, @RequestParam(value = "id", required = false) String id) {
    ...
    return "web/reportType/reportType_edit";
  }
  ...
  public String getDataList(@ModelAttribute CommonPageDto pageDto,
      @ModelAttribute ReportTypeEntity dto) {
