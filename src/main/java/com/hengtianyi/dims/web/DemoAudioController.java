...
@RestController
@RequestMapping(value = "/web/DemoAudioController")
public class DemoAudioController {
    ...
    public Object appUploadMult(HttpServletRequest request) throws IOException {
        ...
        // 获得文件：
        List<MultipartFile> files = multipartRequest.getFiles("fileAudio1");
        System.out.println( "-->" );
        System.out.println(files);
        if (files.isEmpty()) {
            result.setError("语音为空");
            return result;
        }
