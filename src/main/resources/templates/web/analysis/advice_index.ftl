...
<script>
    ...
    $(document).ready(function () {
        $("#btn-cx").on("click", function () {
            ...
            $.ajax({
                "url": "a/analysis/adviceData.json",
                "type": "POST",
                "data": data,
                "dataType": "json",
                "cache": false,
    ...
    function initPieData(pieData) {
        ...
        const pieOption = {
            ...
            color: ['rgba(219,216,74,0.66)', 'rgba(31,189,194,0.66)', 'rgba(117,24,198,0.66)'],
            series: [
                {
                    type: 'pie',
                    radius: ['50%', '70%'],
                    data: [
                        ...
                        {value: pieData.xiangzhen, name: '乡镇管理员'}
                    ]
                }
            ]
        };
